...
property — [#547](https://github.com/diazoxide/charter-plane/issues/547) (a flag's spelling, not
its parse), [#558](https://github.com/diazoxide/charter-plane/issues/558) (the ref's spelling,
not whether the check ran), [#537](https://github.com/diazoxide/charter-plane/issues/537),
[#498](https://github.com/diazoxide/charter-plane/issues/498),
[#577](https://github.com/diazoxide/charter-plane/issues/577) — and the first where the right
...
([#508](https://github.com/diazoxide/charter-plane/issues/508)), then `worktree history`,
`status` and `recall` ([#592](https://github.com/diazoxide/charter-plane/issues/592)). The last
