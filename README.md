...
| `crates/persona-statistics` | An extension, and the executor's first consumer: the persona statistics view (charter ADR 0041 stage 2). `cargo run --release -p persona-statistics -- assemble <dir>`, then install `<dir>` from Extensions |
