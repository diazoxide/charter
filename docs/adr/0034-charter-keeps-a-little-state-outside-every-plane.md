...
draws what is pinned, so the first open of a plane pins its three most recently active workspaces,
and this records that it happened so that an operator who unpins everything is not pinned again.
